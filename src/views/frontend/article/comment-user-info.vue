...
<script setup lang="ts" name="CommentUserInfo">
    import { computed, reactive, ref, getCurrentInstance, ComponentInternalInstance } from 'vue';
    ...
    const onClickSave = async () => {
        ...
        globalStore.setCommontUserInfo(formModel);

        globalProxy.$message.success(`辛苦啦，可以去创建${props.topic}了！`);
