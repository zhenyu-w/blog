...
export class ApiService {
    ...
    // delete请求
    protected $del<T extends CommonResponse>(
        action: string,
        params: PlainObject = {},
        config: PlainObject = {}
    ): Promise<T> {
    ...
    protected $delJson<T extends CommonResponse>(
        action: string,
        params: PlainObject = {},
        config: PlainObject = {}
    ): Promise<T> {
    ...
    protected $postJson<T extends CommonResponse>(
        action: string,
        params: PlainObject = {},
        config: PlainObject = {}
    ): Promise<T> {
    ...
    protected $putJson<T extends CommonResponse>(
        action: string,
        params: PlainObject = {},
        config: PlainObject = {}
    ): Promise<T> {
    ...
    // patch请求
    protected $patch<T extends CommonResponse>(
        action: string,
        params: PlainObject = {},
        config: PlainObject = {}
    ): Promise<T> {
    ...
    protected $patchJson<T extends CommonResponse>(
        action: string,
        params: PlainObject = {},
        config: PlainObject = {}
    ): Promise<T> {
